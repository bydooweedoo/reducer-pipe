...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerPipe = __webpack_require__(3);

	var _reducerPipe2 = _interopRequireDefault(_reducerPipe);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _reducerPipe2.default;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var pipe = function pipe(iteratee, reducers) {
	    return function (state, action) {
	        var compare = iteratee(state);

	        return _ramda2.default.reduce(function (savedState, reducer) {
	            return compare(savedState, reducer(savedState, action));
	        }, state, reducers);
	    };
	};

	var safePipe = _ramda2.default.converge(pipe, [_ramda2.default.pipe(_ramda2.default.nthArg(0), _reducerUtils.iteratee.getIterateeOrUseDefault), _ramda2.default.pipe(_ramda2.default.nthArg(1), _reducerUtils.reducer.getReducers)]);

	var safePipeCurried = _ramda2.default.curryN(2, safePipe);

	var withSingleArg = _ramda2.default.cond([[_reducerUtils.iteratee.isIteratee, safePipeCurried], [_reducerUtils.reducer.areReducers, safePipeCurried(null)], [_ramda2.default.T, safePipe]]);

	var curriedPipe = _ramda2.default.unapply(_ramda2.default.cond([[_ramda2.default.pipe(_ramda2.default.length, _ramda2.default.equals(1)), _ramda2.default.pipe(_ramda2.default.head, withSingleArg)], [_ramda2.default.T, _ramda2.default.apply(safePipe)]]));

	curriedPipe.compare = _reducerUtils.compare;

	exports.default = curriedPipe;
	module.exports = exports['default'];
