...
describe('reducer-pipe', () => {
    ...
    it('should returns given state if no array given', () => {
        const reducer = reducerPipe(null);
    ...
    it('should call all reducers once', () => {
        ...
        const reducer = reducerPipe([spy1, spy2, spy3]);
    ...
    it('should call all reducers with previously returned state but same action', () => {
        ...
        expect(spy2).toHaveBeenCalledWith(state1, action);
        expect(spy3).toHaveBeenCalledWith(state2, action);
    });
    ...
    describe('#compare', () => {
        ...
        describe('custom - reducerPipe(customCompare, reducers)', () => {
            ...
            it('should use given compare instead of default', () => {
                const reducer = reducerPipe(compare, [spy1, spy2, spy3]);
        ...
        describe('curry - reducerPipe(customCompare)(reducers)', () => {
            ...
            beforeEach(() => {
                ...
                iteratee = expect.createSpy().andReturn(state);
                compare = expect.createSpy().andReturn(iteratee);
                customChain = reducerPipe(compare);
            });
